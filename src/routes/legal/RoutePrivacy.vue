            ...
            ><strong
              ><span style="font-size: 15px"
                ><span data-custom-class="subtitle"
                  >Last updated
                  <bdt class="question">September 07, 2022</bdt></span
                ></span
              ></strong
            ></span
          >
          ...
          <span style="color: rgb(127, 127, 127)"
            ><span style="color: rgb(89, 89, 89); font-size: 15px"
              ><span data-custom-class="body_text"
                ...
                <bdt class="question">Team Concords Limited</bdt
          ...
          <span style="font-size: 15px"
            ><span style="color: rgb(127, 127, 127)"
              ><span data-custom-class="body_text"
                ...
                <bdt class="question">owner@concords.app</bdt>.</span
              ></span
            ></span
          >
        </div>
        ...
        <div style="line-height: 1.5">
          <span style="font-size: 15px"
            ><span data-custom-class="body_text"
              ...
              we have a valid legal reason to do so. Click&nbsp;</span
            ></span
        ...
        <div style="line-height: 1.5">
          <span style="font-size: 15px"
            ><a data-custom-class="link" href="#caresidents"
              ><span style="color: rgb(89, 89, 89)"
                >13. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span
              ></a
            ></span
          >
        </div>
          ...
          <span style="font-size: 15px; color: rgb(89, 89, 89)"
            ><span style="font-size: 15px; color: rgb(89, 89, 89)"
              ><span data-custom-class="body_text"
                ...
                called <bdt class="block-component"></bdt>'<bdt
                  class="else-block"
                ></bdt
                ><span style="font-size: 15px"
                  ><span data-custom-class="body_text"
                                                                  ...
                                                                  >
                                                                    <span
                                                                      ...
                                                                      ><span
                                                                        ...
                                                                        <bdt
                                                                          class="question"
                                                                          >privacy@footballsocial.app</bdt
                                                                        >.</span
                                                                      ></span
                                                                    ><bdt
                                                                      class="statement-end-if-in-editor"
