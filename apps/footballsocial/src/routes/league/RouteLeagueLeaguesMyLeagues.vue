  ...
  <div v-for="league in leagues" :key="league.id" class="p-2">
    <div class="flex flex-col">
      <div class="flex items-center py-8 border-b">
        <div class="w-50">
          <p class="text-lg text-center tracking-tighter uppercase">Code</p>
          <div
            class="mt-2 p-6 text-4xl text-base-100 bg-base-content text-center font-bold tracking-tighter"
          >
            {{ league.league_code }}
          </div>
        </div>
