...
<template>
  <div class="flex items-center mt-16">
    <div class="w-16 h-16 relative mr-4 lg:mr-8">
      <svg
        class="fill-white w-16 h-16 mr-2 absolute top-1 left-1"
        viewBox="0 0 48 48"
      >
        <g>
          <path
      ...
      <svg
        class="fill-pink-600 w-16 h-16 mr-2 absolute top-0 left-0"
        viewBox="0 0 48 48"
      >
        <g>
          <path
    ...
    <h1 class="text-6xl font-light shadow-text">
      {{ title }}
    </h1>
  </div>
</template>
