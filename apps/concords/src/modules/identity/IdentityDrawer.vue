...
<template>
  <div class="mt-4">
    <p class="my-3 text-2xl font-thin w-full max-w-5xl mx-auto">
      ...
      key, also known as an "avatar." These avatars are derived from the user's
      identity key and are both reproducible and predictable.
    </p>
  ...
  <p class="my-3 text-2xl font-thin w-full max-w-5xl mx-auto mt-4">
    As we use identity keys, Concords doesn't need a server-side login. The key
