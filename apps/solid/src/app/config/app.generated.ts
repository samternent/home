...
export const landingPageConfig = {
  ...
  hero: {
    ...
    description:
      "Concord OS for Solid is a platform shell for browsing Pod files, opening replayable Concord ledgers, and running registry-backed apps against portable history. The shell owns login, loading, saving, and app lifecycle so individual tools do not need to own your storage model.",
    ...
    preview: {
      ...
      footerText:
        "Concord OS for Solid will treat the Pod like a workspace surface. Files remain in Solid, ledgers remain portable, and apps plug into the shell rather than owning the persistence story outright.",
    },
  },
  featureSection: {
    eyebrow: "Features",
    ...
    description:
      "Concord OS for Solid is not another app-specific frontend. It is the shared operating layer that can discover storage, load ledgers, and host compatible experiences over the same Pod data.",
    items: [
      {
        title: "Filesystem over Pod storage",
        description:
          "Navigate Solid storage as a durable workspace instead of hiding data behind one app at a time.",
        tone: "primary",
        icon: "stack",
      },
      {
        ...
        description:
          "Keep multiple Concord ledgers side by side and open them intentionally when context changes.",
        tone: "info",
        icon: "dataset",
      },
      {
        ...
        description:
          "Let compatible apps attach to the same ledger instead of forcing one ledger to belong to one interface forever.",
        tone: "accent",
        icon: "grid",
      },
      {
        ...
        description:
          "The shell handles login, loading, saving, and future plugin mounting so app surfaces can stay focused on domain workflows.",
        tone: "success",
        icon: "terminal",
      },
    ],
  ...
  howItWorksSection: {
    ...
    preview: {
      ...
      footerText:
        "The operating shell becomes the stable entrypoint. Specific apps can come and go as long as they can speak to the files and ledgers behind them.",
    },
    steps: [
      {
        title: "Authenticate against Solid",
        description:
          "Use Solid OIDC to establish the session the shell will carry across workspace interactions.",
      },
      {
        title: "Inspect Pod resources",
        description:
          "Present storage as a navigable surface so ledgers and supporting files are visible and movable.",
      },
      {
        title: "Resolve compatible apps",
        description:
          "Match files and ledgers to registered app experiences instead of hard-coding one UI for one dataset.",
      },
      {
        title: "Mount the right workspace",
        description:
          "Load a focused app surface inside the shell while keeping lifecycle and persistence at the platform layer.",
      },
    ],
  },
  useCasesSection: {
    ...
    items: [
      {
        ...
        description:
          "Keep a persistent workspace around the files and histories that matter to you across multiple Solid apps.",
        tone: "primary",
        icon: "globe",
      },
      {
        ...
        description:
          "Let one ledger support more than one interface when different tools can interpret the same history.",
        tone: "secondary",
        icon: "shield",
      },
      {
        ...
        description:
          "Keep shared files and replayable ledgers in Solid instead of binding collaboration to one hosted product.",
        tone: "accent",
        icon: "check",
      },
      {
      ...
      },
      {
        ...
        description:
          "Explore UI ideas over the same replayable history before deciding which app surface should become primary.",
        tone: "primary",
        icon: "stack",
      },
      {
        ...
        description:
          "Move between compatible surfaces without rewriting or exporting the underlying ledger every time.",
        tone: "success",
        icon: "dataset",
      },
    ],
  ...
  developerSection: {
    ...
    description:
      "Concord OS for Solid is a host environment. Use the shell for Solid session lifecycle and storage conventions, then compose domain apps on top of compatible ledgers and plugin contracts.",
    surfaces: ["Solid session", "Ledger host", "Plugin apps"],
    tabs: [
      {
        value: "shell",
        label: "Shell",
      ...
      },
      {
        ...
        supportingCopy:
          "The shell should stay boring and durable. Apps should stay focused and replaceable.",
        link: {
          href: "https://github.com/samternent/home/tree/main/apps/solid",
  ...
  ctaSection: {
    ...
    description:
      "Enter the first authenticated Concord OS surface now, then grow the filesystem, ledger browser, and app registry on top of the same Solid session model.",
    primaryAction: {
      href: "/app",
      label: "Open app",
      variant: "primary",
