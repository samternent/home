...
- Model resources in terms of providers, mounts, paths, handles, and metadata.
- Solid-specific implementation details should stop at this boundary and live behind a provider contract.
