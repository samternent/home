...
async function shareKeys() {
  ...
  try {
    ...
    successMessage.value = `Keys shared successfully with ${
      selectedUser.value.name || selectedUser.value.identity
    }!`;
