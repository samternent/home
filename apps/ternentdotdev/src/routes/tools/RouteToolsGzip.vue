...
const canDecompress = computed(() => {
  return (
    compressedData.value !== null || (inputMode.value === "text" && inputText.value.trim() !== "")
  );
});
...
const decompressData = async () => {
  ...
  try {
    ...
    error.value =
      err.message || "Failed to decompress data. Make sure the file is a valid gzip archive.";
    result.value = "error";
  } finally {
    isLoading.value = false;
  }
    ...
    >
      ...
      <template #default>
        <div class="flex flex-col h-full w-full">
          <!-- Header -->
          <div
            class="flex-shrink-0 p-8 bg-gradient-to-r from-primary/5 to-accent/5 border-b border-base-300"
          >
            <div class="w-full">
              <div class="flex items-center gap-3 mb-4">
                <div
                  class="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center text-2xl"
                >
                  🗜️
                </div>
                <div>
              ...
              <div class="w-full space-y-6">
                    ...
                    <div>
                      <h3 class="text-lg font-semibold text-base-content mb-2">
                        {{
                          activeTab === "compress"
                            ? "Text to compress"
                            : "Text or data to decompress"
                        }}
                      </h3>
                      <p class="text-sm text-base-content/70">
                        {{
                          activeTab === "compress"
                            ? "Enter any text content to compress"
                            : "Paste text or compressed data to decompress"
                        }}
                      </p>
                    </div>
                    <textarea
                  ...
                  <div class="space-y-4">
                    <div>
                      ...
                      <p class="text-sm text-base-content/70">
                        {{
                          activeTab === "compress"
                            ? "Upload any file to compress it"
                            : "Upload a .gz file to decompress"
                        }}
                      </p>
                    </div>
                    <div
                    ...
                    >
                      ...
                      <div v-if="!inputFile" class="space-y-3">
                        <div
                          class="text-4xl group-hover:scale-110 transition-transform duration-200"
                        >
                          📁
                        </div>
                        <div>
                          <p class="font-medium text-base-content">
                            Click to browse or drag and drop a
                            {{ activeTab === "decompress" ? "gzip" : "" }} file
                          </p>
                          <p class="text-sm text-base-content/60 mt-1">Maximum file size: 100MB</p>
                        </div>
                      </div>
                ...
                <SCard class="p-6">
                  <div class="flex gap-3">
                    ...
                    <SButton @click="clearAll" variant="outline" size="md">
      ...
      <template #sidebar>
        <div class="flex flex-col h-full w-full bg-base-100">
          <!-- Results Header -->
          <div
            class="flex-shrink-0 p-6 bg-gradient-to-r from-accent/5 to-secondary/5 border-b border-base-300"
          >
            <div class="flex items-center gap-3">
              <div
                class="w-10 h-10 rounded-lg bg-gradient-to-br from-accent to-secondary flex items-center justify-center text-lg"
              >
                📋
              </div>
              <div>
          ...
          <div class="flex-1 overflow-y-auto">
            <div class="p-6 w-full">
              ...
              <div v-else-if="result === 'success'" class="space-y-4">
                  ...
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-success/80">
                        {{ activeTab === "compress" ? "Compression" : "Decompression" }} completed
                        successfully
                      </p>
                    </div>
                  </div>
                ...
                <div class="space-y-3">
                  <SCard v-if="activeTab === 'compress' && compressedData" class="p-4">
                    <SButton @click="downloadCompressed" variant="primary" size="md" class="w-full">
                      <span class="mr-2">💾</span>
                      Download Gzip File
                    </SButton>
                  </SCard>
              ...
              <SCard v-else class="p-8">
                <div
                  class="flex flex-col items-center justify-center space-y-4 text-base-content/50"
                >
                  ...
                  <div class="text-center">
                    ...
                    <p class="text-sm">
                      {{
                        activeTab === "compress"
                          ? "Enter text or select a file to compress"
                          : "Upload a gzip file or enter data to decompress"
                      }}
                    </p>
                  </div>
                </div>
