...
import { generate, encrypt, decrypt } from "ternent-encrypt";
                ...
                <SCard variant="bordered" size="small">
                  <div class="p-4">
                    ...
                    <div class="flex gap-4">
                      <label
                        class="label cursor-pointer gap-3 p-3 rounded-lg border border-base-300 hover:bg-base-50 transition-colors flex-1"
                      >
                        <input
                          type="radio"
