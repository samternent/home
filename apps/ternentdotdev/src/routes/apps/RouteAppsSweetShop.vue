...
<template>
  <div class="flex flex-col bg-base-200 lg:border border-base-300 lg:shadow-lg rounded overflow-hidden w-full">
    <div class="p-2 w-full flex lg:flex-row flex-col flex-1 h-full">
      ...
      <div class="py-4">
        ...
        <p class="font-normal flex m-2 py-4">
          ...
          <SButton @click="add" type="success">
