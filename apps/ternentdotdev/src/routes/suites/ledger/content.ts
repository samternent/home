...
const ledgerSuite = {
  slug: "ledger",
  title: "Ledger - An append-only state engine for portable application truth.",
  themeName: "ledger",
  defaultThemeMode: "dark",
  seo: {
    shortName: "Ledger",
    description:
      "Ledger is an append-only state engine for portable application truth, deterministic replay, and non-custodial software.",
    themeColor: "#c46a6a",
  ...
  landing: {
    ...
    hero: {
      ...
      preview: {
        ...
        footerText:
          "Ledger keeps committed truth portable and replayable without treating projection as source-of-truth.",
      },
    },
    proofModelSection: {
    ...
    developerSection: {
      ...
      surfaces: ["State engine", "Replay pipeline", "Persistence boundary"],
      tabs: [
        {
          value: "js",
          label: "JavaScript",
          ...
          supportingCopy:
            "Use the package directly when you want explicit control over append, commit, replay, and verification without jumping straight to app-level runtime abstractions.",
          link: {
            href: "https://github.com/samternent/home/tree/main/packages/ledger-v2",
            label: "View source",
          },
        },
        {
          ...
          supportingCopy:
            "Payload protection is explicit. Armour encrypts first, then Ledger seals the resulting entry so the proof binds to encrypted state rather than plaintext.",
          link: {
        ...
        },
        {
          ...
          supportingCopy:
            "Verification checks committed structure, commit chain, entry proofs, and encrypted payload hashes. Projection is derived later and never treated as the source of truth.",
          link: {
            href: "https://github.com/samternent/home/tree/main/packages/ledger-v2",
    ...
    footer: {
      ...
      links: [
        ...
        {
          href: "https://github.com/samternent/home/tree/main/apps/ternentdotdev/src/routes/suites/ledger",
          label: "GitHub",
        },
      ],
    },
