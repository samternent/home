...
const armourSuite = {
  slug: "armour",
  title: "Armour - Encrypt for identities with explicit age-compatible primitives.",
  themeName: "armour",
  defaultThemeMode: "dark",
  seo: {
    shortName: "Armour",
    description:
      "Armour bridges @ternent/identity and @ternent/rage for explicit identity-based and passphrase encryption with age-compatible output.",
    themeColor: "#14b8a6",
    backgroundColor: "#071513",
    lang: "en",
    canonicalPath: "/armour",
  },
  landing: {
    navigationLinks: [
      {
    ...
    proofJsonSection: {
      ...
      supportingText:
        "Armour owns the bridge from identity to age-compatible encryption. Sealed artifacts belong elsewhere in the stack.",
    },
    surfacesSection: {
      eyebrow: "Surfaces",
    ...
    developerSection: {
      ...
      surfaces: ["@ternent/armour", "@ternent/identity", "@ternent/rage"],
      tabs: [
        {
          value: "js",
          label: "JavaScript",
        ...
        },
        {
          ...
          code: 'import {\n  initArmour,\n  encryptForIdentities,\n  decryptWithIdentity\n} from "@ternent/armour"\n\nawait initArmour()\n\nconst ciphertext = await encryptForIdentities({\n  identities: [identity],\n  data: new TextEncoder().encode("portable payload"),\n  output: "binary"\n})\n\nconst plaintext = await decryptWithIdentity({\n  identity,\n  data: ciphertext\n})',
          supportingCopy:
            "Armour exposes raw encryption APIs for byte payloads and explicit output modes. It does not define an envelope or transport container.",
          link: {
            href: "https://github.com/samternent/home/tree/main/packages/armour",
        ...
        },
        {
          ...
          supportingCopy:
            "Passphrase mode is separate from recipient mode. Armour does not overload one function to infer both.",
          link: {
    ...
    footer: {
      ...
      links: [
        ...
        {
          href: "https://github.com/samternent/home/tree/main/apps/ternentdotdev/src/routes/suites/armour",
          label: "GitHub",
        },
      ],
    },
