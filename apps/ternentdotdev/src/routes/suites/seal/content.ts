...
const sealSuite = {
  slug: "seal",
  title: "Seal - A portable proof primitive for signed artifacts.",
  themeName: "proof",
  defaultThemeMode: "dark",
  seo: {
    shortName: "Seal",
    description:
      "Seal is a portable proof primitive for signed artifacts and versioned JSON proofs.",
    themeColor: "#2f81f7",
  ...
  landing: {
    ...
    hero: {
      ...
      preview: {
        ...
        footerText:
          "Seal emits a self-contained proof file that can move between environments unchanged.",
      },
    },
    proofModelSection: {
    ...
    developerSection: {
      ...
      surfaces: ["JavaScript library", "GitHub Action", "CLI"],
      tabs: [
        {
          value: "js",
          label: "JavaScript",
          ...
          supportingCopy:
            "Integrate the library directly when you need control over signing or verification flows. Keep the proof format unchanged across environments.",
          link: {
        ...
        },
        {
          ...
          supportingCopy:
            "The CLI is a thin local surface over the same proof contract, including mnemonic-backed identity creation.",
          link: {
            href: "https://www.npmjs.com/package/@ternent/seal-cli",
        ...
        },
        {
          ...
          supportingCopy:
            "The Action is a CI surface built on the same JavaScript library. Do not fork the proof contract.",
          link: {
            href: "https://github.com/marketplace/actions/seal-action",
    ...
    footer: {
      ...
      links: [
        ...
        {
          href: "https://github.com/samternent/home/tree/main/apps/ternentdotdev/src/routes/suites/seal",
          label: "GitHub",
        },
      ],
    },
