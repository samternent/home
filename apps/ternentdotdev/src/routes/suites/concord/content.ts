...
const concordSuite = {
  slug: "concord",
  title: "Concord - Build apps from replayable, signed history.",
  themeName: "concord",
  ...
  landing: {
    ...
    hero: {
      ...
      preview: {
        ...
        footerText:
          "Concord stages commands, commits them into signed parent-linked history, supports encrypted payloads when needed, and rebuilds application state from replay instead of treating storage as authority.",
      },
    },
    proofModelSection: {
    ...
    developerSection: {
      ...
      surfaces: ["Command runtime", "Explicit commit boundaries", "Replay plugins"],
      tabs: [
        {
          value: "js",
          label: "JavaScript",
