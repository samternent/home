          ...
          <SCard>
            <div class="flex flex-col lg:flex-row gap-micro">
              ...
              <div class="lg:w-2/3">
                ...
                <div
                  v-else
                  class="flex items-center justify-center h-64 bg-surface border-2 border-dashed border-muted rounded-lg"
                >
