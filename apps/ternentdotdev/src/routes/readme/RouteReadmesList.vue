  ...
  <div class="flex-1 p-micro bg-background">
      ...
      <ul class="space-y-1">
        <li>
          <RouterLink
            ...
            class="link text-body-md hover:text-accent transition-colors"
        ...
        <li>
          <RouterLink
            ...
            class="link text-body-md hover:text-accent transition-colors"
            >footballsocial-api</RouterLink
          >
        </li>
        <li>
          <RouterLink
            to="/readme/apps/concords"
            class="link text-body-md hover:text-accent transition-colors"
            >concords</RouterLink
          >
        </li>
    ...
    <SCard>
      ...
      <ul class="space-y-1">
        ...
        <li>
          <RouterLink
            to="/readme/packages/concord-protocol"
            class="link text-body-md hover:text-accent transition-colors"
