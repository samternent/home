      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            :class="{
              'textarea-error': !appForm.description.trim() && currentStep > 1,
            }"
            rows="3"
          ></textarea>
          <div
            v-if="!appForm.description.trim() && currentStep > 1"
            class="text-error text-xs mt-1"
          >
          ...
          <div>
            ...
            <div class="grid grid-cols-4 md:grid-cols-8 gap-2">
              <button
                ...
                :class="{
                  'btn-primary': appForm.icon === icon,
                  'btn-outline': appForm.icon !== icon,
                }"
                :title="icon"
              >
                {{ icon }}
