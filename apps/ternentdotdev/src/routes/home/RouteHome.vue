...
<template>
  <main class="min-h-screen">
    <div
      class="min-h-screen [background:radial-gradient(circle_at_50%_0%,color-mix(in_srgb,var(--ui-primary)_22%,transparent),transparent_42rem),linear-gradient(to_bottom,color-mix(in_srgb,var(--ui-bg)_84%,transparent),transparent_34rem),linear-gradient(color-mix(in_srgb,var(--ui-fg)_12%,transparent)_1px,transparent_1px),linear-gradient(90deg,color-mix(in_srgb,var(--ui-fg)_12%,transparent)_1px,transparent_1px)] [background-size:auto,auto,32px_32px,32px_32px]"
    >
      <section class="mx-auto max-w-6xl px-6 pb-20">
        <div class="mx-auto max-w-5xl pt-16 text-center md:pt-24">
          <p
            class="mb-5 text-xs font-medium uppercase tracking-[0.32em] text-[color:color-mix(in_srgb,var(--ui-primary)_86%,var(--ui-fg))]"
          >
            ternent.dev
          </p>
          ...
          >
            A runtime for replayable applications, signed workflows, and portable state. Build
            systems where history, identity, and trust travel with the software.
          </p>
          ...
          <div class="mt-10 flex flex-wrap justify-center gap-3">
            ...
            <RouterLink
              to="/concord"
              class="rounded-full border border-[color:color-mix(in_srgb,var(--ui-border)_86%,transparent)] bg-[color-mix(in_srgb,var(--ui-bg)_92%,transparent)] px-6 py-3 text-sm font-black text-[var(--ui-fg)] no-underline transition-colors hover:bg-[color-mix(in_srgb,var(--ui-bg)_86%,transparent)]"
            >
              Read the Spec
            </RouterLink>
          </div>
          ...
          <div
            class="mt-12 flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-[var(--ui-fg-muted)] md:text-base"
          >
        ...
        <section id="architecture" class="relative mx-auto mt-20 max-w-4xl md:mt-24">
          <div class="mb-10 text-center">
            <p
              class="text-xs font-semibold uppercase tracking-[0.24em] text-[color:color-mix(in_srgb,var(--ui-primary)_74%,var(--ui-fg))]"
            >
              The protocol beneath the runtime
            </p>
          ...
          <RouterLink
            ...
            class="block rounded-2xl border border-[color:color-mix(in_srgb,var(--ui-primary)_58%,var(--ui-border))] bg-[color-mix(in_srgb,var(--ui-primary)_14%,var(--ui-bg))] p-5 text-[var(--ui-fg)] no-underline transition-all duration-150 hover:-translate-y-0.5 hover:border-[color:color-mix(in_srgb,var(--ui-primary)_78%,var(--ui-border))]"
          >
            <div class="flex items-start justify-between gap-5">
              <div class="flex gap-4">
                ...
                <div>
                  ...
                  <p class="mt-1 text-sm font-bold text-[var(--ui-primary)]">
                    {{ concord.subtitle }}
                  </p>
                  <div
          ...
          <div class="relative hidden h-28 md:block">
            ...
            >
              <path
                ...
                d="M400 0 C400 48 230 42 205 110"
              />
              <path
                class="fill-none stroke-current stroke-[1.6] opacity-80"
                d="M400 0 C400 48 570 42 595 110"
              />
          ...
          <div class="relative hidden h-16 md:block">
            ...
            >
              <path
                class="fill-none stroke-current stroke-[1.6] opacity-80"
                d="M200 0 C200 55 360 20 400 70"
              />
              <path
                class="fill-none stroke-current stroke-[1.6] opacity-80"
                d="M600 0 C600 55 440 20 400 70"
              />
              <path
                d="M400 70 l-7 -10 m7 10 l7 -10"
                class="fill-none stroke-current stroke-[1.6]"
              />
            </svg>
          </div>
          ...
          <RouterLink
            ...
            class="mx-auto block w-full max-w-xl rounded-2xl border border-[color:color-mix(in_srgb,var(--ui-primary)_58%,var(--ui-border))] bg-[color-mix(in_srgb,var(--ui-primary)_14%,var(--ui-bg))] p-5 text-[var(--ui-fg)] no-underline transition-all duration-150 hover:-translate-y-0.5 hover:border-[color:color-mix(in_srgb,var(--ui-primary)_78%,var(--ui-border))]"
          >
            <div class="flex items-start justify-between gap-4">
              <div class="flex gap-4">
                <div
