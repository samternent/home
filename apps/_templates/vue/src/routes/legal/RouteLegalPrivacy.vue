...
<template>
  <div class="p-4 mx-auto mb-12">
    ...
    <p class="my-8">
      This Privacy Policy governs the practices of {{ appLegalName }} regarding
      the collection, usage, maintenance, and disclosure of information obtained
      from users ("User") of the {{ appLegalName }} mobile application ("App").
    </p>

    <h2 class="text-xl font-semibold my-2">Information Collection</h2>
    <p class="mb-4">
      Upon user signup, {{ appLegalName }} collects essential information,
    ...
    <p class="mb-4">
      {{ appLegalName }} strictly refrains from utilizing or sharing the
    ...
    <p class="mb-4">
      {{ appLegalName }} uses GoatCounter for analytics purposes. GoatCounter
    ...
    <p class="mb-4">
      {{ appLegalName }} is committed to adhering to the pertinent data
    ...
    <p class="mb-4">
      {{ appLegalName }} reserves the right to update or modify this Privacy
