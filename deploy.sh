...
# check certification
echo 1 1 | sudo certbot -d footballsocial.app -d www.footballsocial.app -d teamconcords.com -d www.teamconcords.com -d concords.app -d www.concords.app -d ternent.dev -d www.ternent.dev
