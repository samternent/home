...
import { identityUpsertPayloadSchema, type IdentityUpsertPayload } from "./schemas";
...
function applyIdentityUpsert(state: IdentityState, entry: Entry): IdentityState {
...
export function replayIdentity(ledger: LedgerContainer, head?: string): IdentityState {
