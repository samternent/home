...
export interface ICreateFunc {
  (initialData?: Object, difficulty?: number): Promise<void>;
}
export interface ILoadFunc {
  (ledger: ILedger, shouldReplay?: boolean): Promise<void>;
}
...
export default (
  ...
  async function create(data?: Object, difficulty: number = 1) {
