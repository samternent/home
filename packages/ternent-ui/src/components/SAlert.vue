...
<template>
  ...
  >
    ...
    <div class="flex items-start gap-4">
      <!-- Icon -->
      <div
        class="flex-shrink-0 mt-1 h-10 w-10 rounded-2xl border border-base-300/50 bg-base-200/60 backdrop-blur-sm grid place-items-center shadow-sm"
      >
        <slot name="icon">
          <div class="relative">
            <svg
      ...
      <button
        v-if="dismissible"
        @click="emit('dismiss')"
        class="flex-shrink-0 p-2 rounded-xl transition-all duration-200 text-base-content/70 hover:text-base-content hover:bg-base-200/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:ring-offset-2"
