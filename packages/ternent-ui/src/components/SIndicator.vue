...
const typeClasses = computed(() => ({
  ...
  outline: {
    ...
    premium:
      "border border-primary text-primary bg-gradient-to-r from-primary/10 to-primary/20 hover:from-primary/20 hover:to-primary/30",
  },
  soft: {
    ...
    premium:
      "bg-gradient-to-r from-primary/15 to-primary/25 text-primary hover:from-primary/25 hover:to-primary/35",
  },
  glow: {
    primary: "bg-primary text-primary-content shadow-lg shadow-primary/25 hover:shadow-primary/40",
    secondary:
      "bg-secondary text-secondary-content shadow-lg shadow-secondary/25 hover:shadow-secondary/40",
    ...
    premium:
      "bg-gradient-to-r from-primary to-primary/80 text-primary-content shadow-xl shadow-primary/30 hover:shadow-primary/50",
  },
  glass: {
    ...
    premium:
      "bg-gradient-to-r from-primary/20 to-primary/30 border border-primary/40 text-primary backdrop-blur-sm",
  },
}));
</script>
<template>
