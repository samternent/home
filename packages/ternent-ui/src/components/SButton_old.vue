...
import { createComponentClasses } from '../design-system/utils.js';
...
// Computed classes using the new design system
const buttonClasses = computed(() => {
  ...
  if (props.icon && props.variant !== 'ghost-icon') {
    additionalClasses.push('aspect-square', 'p-0');
  }
...
<template>
  ...
  >
    ...
    <div v-if="loading" class="flex items-center gap-2">
      ...
      <span v-if="!icon && $slots.default" class="opacity-70">
        <slot />
      </span>
    </div>
