...
const wrapperClasses = computed(() => {
  const baseClasses = ["relative group transition-all duration-200 ease-out"];
...
const iconClasses = computed(() => {
  ...
  return [
    ...baseClasses,
    sizeClasses[normalizedSize.value] || sizeClasses.md,
    positionClasses[props.iconPosition][normalizedSize.value] ||
      positionClasses[props.iconPosition].md,
  ].join(" ");
});
